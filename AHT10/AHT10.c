...
HAL_StatusTypeDef AHT10_init(I2C_TypeDef *hi2c_) {
	HAL_StatusTypeDef status;

	if ((status = I2C_Master_Transmit(hi2c_, AHT10_ADDRESS, (uint8_t*)&AHT10_COMMAND_INIT, 1, 50)) == HAL_OK) {
		AHT10_hi2c = hi2c_;
	}
...
HAL_StatusTypeDef AHT10_trigger_measure() {
	return I2C_Master_Transmit(AHT10_hi2c, AHT10_ADDRESS, (uint8_t*)&AHT10_trigger_data, 3, 50);
}
