...
#define SA0 				//!< Закомментируйте, если на пине SA0 выставлен RESET

#ifdef SA0
#define LSM6DS33_ADDRESS			0xD7		//!< Адрес датчика при низком уровне пина SA0
#else
#define LSM6DS33_ADDRESS			0xD5		//!< Адрес датчикаа при высоком уровне пина SA0
#endif /* SA0 */
